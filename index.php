<?php include ('partials/default/header-default.php') ?>
<?php include ('partials/features/video-slider.php') ?>
<?php include ('partials/default/core-features-default.php') ?>	
<?php include ('partials/default/offers-default.php') ?>	
