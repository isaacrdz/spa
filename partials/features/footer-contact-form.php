					...
					<div class="row">
						<div class="col-md-12">
							<div class="call-to-action text-center">
								<div class="row">
									<div class="col-sm-8">
										<h2>Solicita ahora tu paquete </h2>
										<h2>No pierdas tiempo</h2>
									</div>
									<div class="col-sm-4">
										<p class="mt-10"><a href="#" class="btn btn-animated btn-lg btn-gray-transparent ">Comprar<i class="fa fa-cart-arrow-down pl-20"></i></a></p>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="footer-content">
										<div class="logo-footer"><h1>Anahuac Spa</h1></div>
										...
										<ul class="list-inline mb-20">
											<li><i class="text-default fa fa-map-marker pr-5"></i> Ubicanos</li>
											<li><i class="text-default fa fa-phone pl-10 pr-5"></i> +52 8119654349</li>
											<li><a href="mailto:info@theproject.com" class="link-dark"><i class="text-default fa fa-envelope-o pl-10 pr-5"></i> info@anahuacspa.com</a></li>
										</ul>
									...
									<div class="footer-content">
										...
										<form role="form" id="footer-form" class="margin-clear">
											...
											<div class="form-group has-feedback mb-10">
												...
												<input type="email" class="form-control" id="email2" placeholder="Ingresa tu correo" name="email2">
